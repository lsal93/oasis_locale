![docker image](https://github.com/lsal93/oasis_locale/actions/workflows/docker-publish.yml/badge.svg)


# lsal93's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of lsal93.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/lsal93/oasis_locale.git
    cd oasis_locale
    ```
    ...
    ```sh
    curl-L -o oasis_locale.zip "https://github.com/lsal93/oasis_locale/archive/main.zip"
    unzip oasis_locale.zip
    cd oasis_locale
    ```
...
your `docker-compose.yaml` with `ghcr.io/lsal93/oasis_locale:main` for the services
...
```sh
docker pull ghcr.io/lsal93/oasis_locale/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/lsal93/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/lsal93/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/lsal93/oasis_locale/manifests/main": unauthorized`
